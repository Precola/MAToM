...
def get_common_args():
    ...
    ## multiprocessing[
    parser.add_argument('--process', type=int, default=5, help='multiprocessing')   #5
    parser.add_argument('--seed', type=int, default=5, help='multiprocessing')
    ...
    parser.add_argument('--num_run', type=int, default='2', help='the number of run')
    ## 'siql', 'scoiql', 'scovdn_weight', 'scovdn', 'stomvdn', 'svdn_self', 'vdn_rnn'
    parser.add_argument('--alg', type=str, default='vdn_rnn', help='the algorithm to train the agent')
    ...
    parser.add_argument('--exp_dir', type=str, default='/HUNT_rnn', help='result directory of the policy_base') #exp
